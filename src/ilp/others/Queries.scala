...
object Queries {
  ...
  def yeastVirtuoso(graphUri: String): String = {
    ...
    WHERE {
      ...
      {
        #proteins(V0) :- path(V2, V3)
        , interaction(V3, V0, V1).
        ? path ex: predicate
        ex: path;
        ex: arg1 ? V2;
        ex: arg2 ? V3.
      ...
      {
        #proteins(V0) :- protein_class(V0, V1)
        , rprotein_class(V0, V1).
        ? pc ex: predicate
        ex: protein_class;
        ex: arg1 ? V0;
        ex: arg2 ? V1.
      ...
      {
        #proteins(V0) :- protein_class(V0, V4)
        , interaction(V2, V0, V1)
        , rprotein_class(V3, V4).
        ? pc ex: predicate
        ex: protein_class;
        ex: arg1 ? V0;
        ex: arg2 ? V4.
      ...
      {
        #proteins(V0) :- phenotype(V0, V3)
        , renzyme(V0, V2)
        , rphenotype(V1, V3).
        ? phenotype ex: predicate
        ex: phenotype;
        ex: arg1 ? V0;
        ex: arg2 ? V3.
      ...
      {
        #proteins(V0) :- protein_class(V0, V3)
        , rprotein_class(V2, V3)
        , enzyme(V2, V1).
        ? pc ex: predicate
        ex: protein_class;
        ex: arg1 ? V0;
      ...
      {
        #proteins(V0) :- interaction(V3, V0, V1)
        , protein_class(V3, V2)
        , rprotein_class(V3, V2).
        ? interaction ex: predicate
        ex: interaction;
        ex: arg1 ? V3;
        ex: arg2 ? V0;
        ex: arg3 ? V1.
      ...
      {
        #proteins(V0) :- path(V2, V1)
        , interaction(V2, V0, V3)
        , rprotein_class(V0, V4).
        ? path ex: predicate
        ex: path;
        ex: arg1 ? V2;
        ex: arg2 ? V1.

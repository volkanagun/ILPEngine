...
r_subst_1(a1,h).
r_subst_1(aa1,single_alk1).
r_subst_1(b1,h).
r_subst_1(bb1,single_alk1).
r_subst_1(c1,h).
r_subst_1(cc1,single_alk1).
r_subst_1(d1,h).
r_subst_1(dd1,single_alk1).
r_subst_1(e1,h).
r_subst_1(ee1,single_alk1).
r_subst_1(f1,h).
r_subst_1(ff1,single_alk1).
r_subst_1(g1,h).
r_subst_1(h1,single_alk1).
r_subst_1(hh1,single_alk1).
r_subst_1(i1,single_alk3).
r_subst_1(ii1,single_alk1).
r_subst_1(j1,single_alk2).
r_subst_1(jj1,single_alk1).
r_subst_1(k1,single_alk2).
r_subst_1(kk1,single_alk1).
r_subst_1(l1,single_alk3).
r_subst_1(ll1,single_alk1).
r_subst_1(m1,single_alk3).
r_subst_1(n1,single_alk3).
r_subst_1(o1,single_alk3).
r_subst_1(p1,single_alk1).
r_subst_1(q1,single_alk1).
r_subst_1(r1,single_alk1).
r_subst_1(s1,single_alk1).
r_subst_1(t1,single_alk1).
r_subst_1(u1,single_alk1).
r_subst_1(v1,single_alk1).
r_subst_1(w1,single_alk1).
r_subst_1(x1,single_alk1).
r_subst_1(y1,single_alk1).
r_subst_1(z1,single_alk1).
r_subst_2(aa1,aro1).
r_subst_2(bb1,aro1).
r_subst_2(cc1,aro1).
r_subst_2(dd1,aro1).
...
r_subst_2(hh1,aro1).
r_subst_2(ii1,aro1).
r_subst_2(j1,groupch32).
r_subst_2(jj1,aro1).
r_subst_2(k1,aro1).
r_subst_2(kk1,aro1).
r_subst_2(l1,o).
r_subst_2(ll1,aro1).
r_subst_2(m1,double_alk1).
r_subst_2(n1,double_alk1).
r_subst_2(o1,double_alk1).
r_subst_2(p1,aro1).
r_subst_2(q1,aro1).
r_subst_2(r1,aro1).
r_subst_2(s1,aro1).

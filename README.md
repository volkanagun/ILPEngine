...
# Dependencies
There is not any primary dependency needed to be defined other than Java JDK21 and Scala SDK 3.8 for using the primary functionality in this code. However in order to experiment and use all the functionality of this project pom.xml - a maven file must be loaded and compiled proparly. 
